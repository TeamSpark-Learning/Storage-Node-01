...
var category = 'critical';

function getByCustomProperty() {
	var filter = azureStorage.TableQuery.stringFilter('LogCategory', azureStorage.TableUtilities.QueryComparisons.EQUAL, category);
